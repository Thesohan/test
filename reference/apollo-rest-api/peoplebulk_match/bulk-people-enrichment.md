...
metadata:
  description: >-
    ...
    <br><br>Calling this endpoint does consume credits as part of your <a
    href="https://docs.apollo.io/docs/api-pricing" target="_blank">Apollo
    pricing plan</a>. This feature is not accessible to Apollo users on free
